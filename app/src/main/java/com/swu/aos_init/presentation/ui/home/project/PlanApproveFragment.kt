...
import com.swu.aos_init.databinding.FragmentPlanApproveBinding
...
class PlanApproveFragment : BaseFragment<FragmentPlanApproveBinding>(R.layout.fragment_plan_approve) {
    ...
    private fun connectApproveAdapter() {
        ...
        partnerApprovePlanAdapter.submitList(
            listOf(
                ...
                ResponseApprove(R.drawable.img_heaven, "김혜빈","heaven@gmail.com")
            )
        )
    }
}
